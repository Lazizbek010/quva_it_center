        ...
        <div class="about">
          ...
          <div class="about__info">
            <div class="about__info__item">
              <h2>Новичкам</h2>
              <p>
                Поможет освоить востребованную профессию с заработком от
                500$/мес
              </p>
            </div>
            <div class="about__info__item">
              <h2>Владельцам бизнеса</h2>
              <p>
                Поможет расширить влияние и узнаваемость вашего бренда,
                рассказать о себе и получать больше клиентов
              </p>
            </div>
            <div class="about__info__item">
              <h2>Специалистам</h2>
              <p>
                Вы поднимите качество знаний на новый уровень, узнаете много
                нового и получите возможность выйти на рынок США
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="info">
            ...
            <div class="info__right">
              <ul class="info__right__list">
                ...
                <li>
                  <img src="images/loading.png" alt="" />
                  <span>Составлять хорошие обьявления</span>
                </li>
                <li>
                  <img src="images/loading.png" alt="" />
                  <span>Стратегиям назначения ставок</span>
                </li>
                <li>
                  <img src="images/loading.png" alt="" />
                  <span>Находить креативные решения для продвижения</span>
                </li>
                <li>
                  <img src="images/loading.png" alt="" />
                  <span
                    >Оптимизировать рекламные кампании и улучшать
                    результаты</span
                  >
                </li>
                <li>
                  <img src="images/loading.png" alt="" />
                  <span
                    >Работать с ключевыми словами и поисковыми запросами</span
                  >
                </li>
                <li>
                  <img src="images/loading.png" alt="" />
          ...
          <div class="prices">
            ...
            <div class="price">
              <div class="price__info">
                ...
                <p>
                  Стоимость полного курса с материалами и доступом в общий чат 5
                  000 грн
                </p>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="instructor__info">
            ...
            <div class="instructor__info__img">
              <img src="images/instructor-img.png" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="course-items">
            ...
            <div class="course-item">
              ...
              <p>
                Участвуете в создании поисковой рекламной кампании. Получаете
            ...
            <div class="course-item">
              ...
              <p>Вы присутствуете на лекциях, получаете новые знания и опыт</p>
            </div>
            <div class="course-item">
              <div class="course-item__top">
                <div class="course-item__top__triangle">
                ...
                <div class="course-item__top__shape"></div>
                <h3>Самостоятельная практика</h3>
              </div>
              <p>
        ...
        <div class="container">
          ...
          <form action="#" class="form">
            ...
            <div class="input-form">
              ...
              <input type="email" id="email" name="email" placeholder="Ваше e-mail">
            </div>
            <label for="tel">Ваш телефон</label>
            <div class="input-form">
              <img src="images/tel.svg" alt="">
              <input type="tel" id="tel" name="tel" placeholder="+380">
            </div>
            <button type="submit" class="form-btn">Записаться на курс</button>
          </form>
        </div>
      </section>
    </footer>
